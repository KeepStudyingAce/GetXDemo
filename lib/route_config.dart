...
import 'package:getx_demo/pages/counter_build_page.dart';
import 'package:getx_demo/pages/counter_get_page.dart';
import 'package:getx_demo/pages/get_jump_one_page.dart';
import 'package:getx_demo/pages/get_jump_two_page.dart';
/*
1、导航到新的页面
Get.to(NextScreen());
...
*/
class RouteConfig {
  static final String counterBuildOne = "/counter/buildOne";
  static final String counterGetOne = "/counter/getOne";
  ...
  static final List<GetPage> getPages = [
    GetPage(name: counterBuildOne, page: () => CounterBuildPage()),
    GetPage(name: counterGetOne, page: () => CounterGetPage()),
